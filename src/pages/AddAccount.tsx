      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <SocialAccountCard
            ...
            title="Instagram Business or Creator Profile"
          >
            <Button variant="outline" disabled>Coming soon</Button>
          </SocialAccountCard>

          {/* Other social account cards... */}
          {/* TikTok */}
          <div className="flex items-center justify-between p-4 bg-white rounded-lg border">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold">TikTok Profile</h3>
              </div>
            </div>
            <Button variant="outline" disabled>Coming soon</Button>
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-white rounded-lg border">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold">X Profile</h3>
              </div>
            </div>
            <Button variant="outline" disabled>Coming soon</Button>
          </div>
