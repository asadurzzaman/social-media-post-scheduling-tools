...
export const AccountsList = ({ facebookAccounts, instagramAccounts, onDisconnect }: AccountsListProps) => {
  return (
      ...
      <div className="space-y-4">
        <div className="space-y-4">
          ...
          {instagramAccounts.length > 0 && (
            <div>
              <h3 className="text-lg font-semibold mb-3">Instagram Accounts</h3>
              {instagramAccounts.map((account) => (
                <SocialAccountCard
                  key={account.id}
                  platform="Instagram"
                  icon={
                    <svg className="w-8 h-8 text-pink-600" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  isConnected={true}
                  accountName={account.instagram_username || account.account_name}
                  accountId={account.id}
                  onDisconnect={() => onDisconnect(account.id)}
                >
                  <Button variant="destructive" onClick={() => onDisconnect(account.id)}>
          ...
          <div>
            ...
            <SocialAccountCard
              platform="LinkedIn"
              icon={
                <svg className="w-8 h-8 text-blue-700" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
